...
* Make the element with both the `avatar` and `proportioned` classes 300 pixels wide, then give it a height so that 
* it retains its original square proportions (don't hardcode in a pixel value for the height!).
